...
function [PSNR, reconstructed_image]  = ...
    PCS_PL_ED_Decoder_shoulian (y, original_image, lambda, Phi, key_matrix, NPT_model, a, num_rows, num_cols, num_levels, max_iterations)
...
reconstructed_image =  NINPT_decryption (x, num_rows, num_cols, a, key_matrix, NPT_model);      %   解密
...
x_hat = NINPT_decryption (x_hat, num_rows, num_cols, a, key_matrix, NPT_model);    %  逆NPT变换
...
x_bar = NINPT_encryption (x_bar, num_rows, num_cols, a, key_matrix, NPT_model);      %   加密变到密文域
