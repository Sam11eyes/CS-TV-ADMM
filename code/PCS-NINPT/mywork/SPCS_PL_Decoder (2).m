...
function reconstructed_image = ...
    SPCS_PL_Decoder (y, Phi, pinvPhi, Index, num_rows, num_cols, num_levels, max_iterations)
...
for i = 1:max_iterations
    ...
    i 
  [x, D] = SPLIteration(y, x, Phi, pinvPhi, Index, num_rows, num_cols, ...
      lambda, num_levels);
...
function [x, D] = SPLIteration(y, x, Phi, pinvPhi, Index, num_rows, num_cols, ...
    lambda, num_levels, last)
...
x_hat  = Unscramble (Index, x_hat);

% x_hat = wiener2(x_hat, [3, 3]);                   %  维纳滤波
