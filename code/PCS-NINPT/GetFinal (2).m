...
pw1 = 1 ;pw2 = 1 ;pw3 = 1 ;pw4= 2 ;
%%  — — — — —  — — — — — — — — — — — — — — — — — — — — — — — — — — — — — — — — —

%  测试图像选择 ( dataset11)

                                  %    图像文件名（这样做的好处在于实验时更改方便）
...
key_matrix = NPTmodel (num_rows, num_cols,x01,mu1);
...
%%  压缩感知测量和重构
 ...
 for k = 1: 1 : 1
     ...
     AAAMA = max(y(:)); % 整个矩阵的最大值
     AAAMI = min(y(:)); % 整个矩阵的最小值
...
yfinal3 = int8(yfinal2);
   ...
   hash = logicalToHex(matrixHash_chaotic_Very2(yfinal3,a,b,c,d,x01,mu1));
